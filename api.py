    ...
    try:
        ...
        return {
            **info,
            ...
            "custom_health_check": config_manager.get_custom_health_check(container_id)
        }
...
async def unquarantine_container(container_id: str):
    ...
    try:
        config_manager.unquarantine_container(container_id)
        config_manager.clear_restart_history(container_id)
...
async def get_health_check(container_id: str):
    ...
    health_check = config_manager.get_custom_health_check(container_id)
    if not health_check:
...
async def delete_health_check(container_id: str):
    ...
    try:
        config_manager.remove_custom_health_check(container_id)
